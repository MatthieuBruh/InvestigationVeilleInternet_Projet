...
from scraper.lematin.matin_comments import scrap_comments
...
def get_title(dr):
    val = dr.find_element(By.XPATH,
                          "/html/body/div[1]/div[4]/div/div/div[3]/article/header/div[2]/h2")
    return val.text.split(":")[1].strip()

def get_date(dr):
    res = dr.find_element(By.XPATH,
                          "/html/body/div[1]/div[4]/div/div/div[3]/article/header/div[1]/div/time")
    return res.get_attribute("datetime")

def get_description(dr):
    res = dr.find_element(By.XPATH, "/html/body/div[1]/div[4]/div/div/div[3]/article/header/div[3]/p")
    return res.text

def get_url_comments(art_url):
    return "https://www.lematin.ch/comment/" + get_id(art_url)
