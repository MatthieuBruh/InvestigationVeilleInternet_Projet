from heures_articles_scraper import flush_article_batch
from heures_category_scraper import start_scraping
from heures_comments_scraper import flush_comment_batch
from heures_dbConfig import get_connection, close_connection
...
def init_database():
    ...
    try:
        ...
        with open('heures_db_schema.sql', 'r', encoding='utf-8') as f:
            sql_script = f.read()
